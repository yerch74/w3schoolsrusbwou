...
clickTab('scssfile');
function clickTab(x) {
  document.getElementById("scssfile").style.display = "none";
  document.getElementById("cssfile").style.display = "none";
  document.getElementById("htmlfile").style.display = "none";
  document.getElementById(x).style.display = "block";

  document.getElementById("scssfiletab").className = document.getElementById("scssfiletab").className.replace(" tabselected", "");
  document.getElementById("cssfiletab").className = document.getElementById("cssfiletab").className.replace(" tabselected", "");
  document.getElementById("htmlfiletab").className = document.getElementById("htmlfiletab").className.replace(" tabselected", "");
